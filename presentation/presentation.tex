...
\begin{itemize}
\item Using Emotional Intelligence in Assitive Systems
\item To augment the COACH system with an emotional reasoning engine so that the augmented system:\\
\begin{itemize}
...
\begin{figure}
\centering
\includegraphics[trim = 5mm 15mm 5mm 20mm, clip, width=.8\linewidth]{fig/fig-system-overview-0.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[trim = 5mm 15mm 5mm 20mm, clip, width=.8\linewidth]{fig/fig-system-overview-1.pdf}
\end{figure}
\end{frame}

\begin{frame}
\frametitle{Design - the Planstep and Emotion Updater cont.}
...
\begin{figure}
\centering
\includegraphics[trim = 5mm 15mm 5mm 20mm, clip, width=.8\linewidth]{fig/fig-system-overview-2.pdf}
\end{figure}
\end{frame}

\begin{frame}
\frametitle{Design - the EPA-Calculator cont.}
\begin{itemize}
...
\begin{figure}
\centering
\includegraphics[trim = 5mm 15mm 5mm 20mm, clip, width=.8\linewidth]{fig/fig-system-overview-3.pdf}
\end{figure}
\end{frame}

\begin{frame}
\frametitle{Design - the Observer cont.}
\begin{itemize}
%state how the original hand-tracker works
\item Step 1: Get the locations of the user's hands
\begin{itemize}
\item bases on a body tracker implemented in a previous work
...
\begin{figure}
\centering
\includegraphics[trim = 5mm 15mm 5mm 20mm, clip, width=.8\linewidth]{fig/fig-system-overview-4.pdf}
\end{figure}
\end{frame}

\begin{frame}
\frametitle{Design - the Prompt Selector and Player cont.}
\begin{itemize}
%describe the survey - insert figure: examples of the prompts
\item The prompt dataset 
\begin{itemize}
\item 30 audio-visual prompts generated in a previous study
...
\item acted more powerfully and more actively in the first test than in the second
\item results shown in thesis
\end{itemize}
\vspace{.3cm}
15 further tests were also run. Results are in the Appendix.
\end{frame}
...
\begin{itemize}
\item In general, the system is able to produce propositionally useful system prompts.
\end{itemize}
...
\end{itemize}
\vspace{.2cm}
This is the same as predicted by the Affect Control Theory.
\end{columns}
\end{itemize}
\end{frame}
...
Contribution
\begin{itemize}
\item designed, implemented and tested a prototypical hand-washing system that fullfills the objectives
\item indicated a correlation between the EPA values of user behaviours, user identities, and system prompts
\end{itemize}
\vspace{.3cm}
Future Work
\begin{itemize}
\item{improve the EPA-Calculator}
\item{improve the reasoning engine}
\item{generate better prompt datasets}
